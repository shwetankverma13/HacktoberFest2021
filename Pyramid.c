...
// How the code work:
// At first ask user for height
// Then if the height is less than 1 or greater than 8 then go back at one step
// Now iterate from 1 through height
// So if at iteration i,
// You should have print i hashes and then a newline as well.
// Note: There must be real number between 1 and 8
